...
import {
    defineComponent, onMounted, onUpdated, onBeforeUnmount, ref, createVNode, cloneVNode,
} from 'vue';
import { ItemProps } from './props';

// wrapping for item
export const WVirtualListItem = defineComponent({
    ...
    setup (props, { attrs }) {
        ...
        const {
            tag, extraProps = {}, index, source, scopedSlots = {}, uniqueKey, slotComponent,
        } = props;
        ...
        const tempNode = createVNode(tag, {
            key: uniqueKey,
            role: 'listitem',
